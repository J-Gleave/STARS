      ...
      REAL*8 CEN, AIJ, CG, Z2, BOLTZM, EVOLT, CR, PI4
      REAL*8 CEVB, CHEMMU, AME, RSUN, LAMC3, PRESKR, CXD, AMU
      REAL*8 CNSTS, CXC, QRT, CMEVMU, RHOKR, CLN10, CSECYR, BOLTZ
      REAL*8 LOG, ECHAR, LSUN, SQRT, AM, OMG, Z1, CZB
      REAL*8 CA, CHE, CXA, CB, CZD, CRHO, BN, STEFBOLTZ
      REAL*8 CPL, CXB, PLANCK, TSUNYR, CZA, ATDATA, CPI, CHI
      REAL*8 CQ, GAMMA1, DH2, CZC, MSUN, VZ, ATAN, BASEN
      REAL*8 CD, CL, QNT, D0, CT, MASLOS, LAMC
      INTEGER I, J, IZ, NCDATA
