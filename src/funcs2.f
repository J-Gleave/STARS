      ...
      REAL*8 RANE22, DW, RANE, HT, RPC14, RANE22N, W6, RNSI30
      REAL*8 RCO, ETH, DECAY, SURFCOMPOS, ABUND, WW2, RANA23NT, W5
      REAL*8 DIFFU2, AM, RPBE, RDFE60, RPLI, RAN15G, TRB, RPNE21
      REAL*8 DMU, RPNA23A, XA2, RNS34S, R33, RNFE60, RNO17A, RPMG26
      REAL*8 DM, RPB11, W1, RNNE22, RANE21, RNNA22A, DMUREAL, RBE
      REAL*8 RNN15, HNUC, RPNE22, RN26TP, SGTH, RAC13N, RNC14, RNS33
      REAL*8 PIRHOR2, RN26GP, RPMG24, RP26G, RNNA23, DSG, RPF19A, RNF19
      REAL*8 STAT2, DEXP, RN26TA, RNNI59A, RPNA23, RPMG26MN, RPNA23N, RNS32A
      REAL*8 RDNI59, RPO18A, RPNG, RAMG25P, RAO18N, RN26GA, RN26G, RANA23NM
      REAL*8 ELEMENT, RPMG25T, RPNA22, RPSI30, DAM, YLIN, DOUTF, DT
      REAL*8 RDAL26G, RNFE56, GRAD, ZT, RANA23NG, RNS32, EGR, RPMG25G
      REAL*8 RPF19, RNMG26, RAC14, RAMG25, RG26MP, RAO, RD26M, R34
      REAL*8 RNC12, RNS33A, RCC, RDNA22, RNFE58, RDC14, GT, RPNE20
      REAL*8 ATM, RAMG26P, CSI, RNC13, AF, RN26GAD, RNNI59, BARYN
      REAL*8 AT, WN, W, RPSI28, DMK, RNSI29, RNSI28, RP26T
      REAL*8 RHO, DWN, VLEDD, Y, ROO, RPAL27, DMT, RNNI58
      REAL*8 RPAL27A, OUTF, W7, RPO, RPSI29, XA, VM, DINF
      REAL*8 ABUND2, A12, RNFE59, RANE21N, RNO18, T, RAF19, RPMG26GN
      REAL*8 RNN14, RNN14P, OP, RPP, RNP, EQ, RP26M, RNMG24
      REAL*8 RAO18, RNO16, W8, RNNA22P, RGMG, RNNI61S, SIG, W2
      REAL*8 RNS34, R, RAN, RAMG25N, YDOT, RPN15, GKT, RPO17A
      REAL*8 RCCG, RAMG26, R3A, WR, RNMG25, DHNUC, CFE, RNLI7
      REAL*8 RLIA, REBE, RN26MP, W3, CMG, DINFN, RPMG25M, RNNI59P
      REAL*8 RAAL27N, RNCO59, RAMG26N, RG26TP, RNNI60, D, RNNE21, RPN
      REAL*8 RLF, RPC, GR, RNNE20, RPD, RPO18, RAO17N, RATETOT
      REAL*8 RNHE3, RPO17, RG26GP, RAC, RGNE, RPC13, RATES, RAMG24
      REAL*8 RNAL27, RDFE59, RDN, AUXIN, ZS, SURFCO, RN26MA, FRAC
      REAL*8 RBP, TRANS, RNFE57, RNP31, SODDS, RPN15A, RPMG26TN, QQ
      REAL*8 WW
      INTEGER II, JW, IZZ, K1, IML, IN, IMO, M
      INTEGER INFN, K2, NAN, ICN, NE, IOP, IDIFF, ISGTH
      INTEGER IW, INUC, K, LE, IBC, NRATES, NUCMAT, MAXMSH
      INTEGER J, ITER, ION, NEUTRO, I, ICL, ISTAR, ISTAROTHER
      INTEGER INF, LT
...
! 1/9/03 Minor element reactions from Clayton 1963
     ...
     :               - RPMG26Gn - RAMG26n + Rn26Mp + Rn26Ma + Rn26G
     ...
     :               + RnS33a + RnN14p + RnNi59p + RnNi59a + RnO17a + RnS32a
      ...
      YDOT(10) = RPN15A - RPN + RAN15g - RPO18a + RnN15 -  RnC14 - RnN14 + RPN15
      YDOT(11) = - RPO + RPO17a + RAO17n - RnO16 + RnO17a + RPO17
      YDOT(12) = - RAN - RAC14 + RPO18 + RPO18a + RAO18 + RAO18n + RnO18 - RPO17
      YDOT(13) = - RAN15g + RPF19 + RPF19A + RAF19 - RnNA22a - RnO18 + RnF19 - RPO18
      YDOT(14) = - RAO18n + RPNE21 + RANE21 + RANE21n + RnNe21 - RnNe20 - RPNE20
      YDOT(15) = - RAO18 - RAF19 + RPNE22 + RANE22 + RANE22n - RnNA22p - RDNA22
     :           - RnNe21 + RnNe22
