...
!     energy and neutrino release
      ...
      REAL*8 TL, NSI28, NDATA, NNB7, NMG26, NFE58, N20, XB
      REAL*8 ABS, ZW, NS32, STAT2, VE, CSA, WC, RDNI59
      REAL*8 NS33, DSTR, CLN10, RPNG, NNI59, DLOG, EXH, N56
      REAL*8 CZW, CZD, STAT1, RDAL26G, ZT, N1, NN18, CZC
      REAL*8 EXC, N, NN12, NFE59, VZ, NNI60, QNT, NNG
      REAL*8 RAO, NE, RD26M, R34, ZB, RCC, PI4, NN11
      REAL*8 RDNA22, VL, RDC14, EXP, N26M, NMG24, W, N16
      REAL*8 STRN, CSD, ZC, RHO, ROO, NNL7, CBRT, RN
      REAL*8 N28, RPO, XA, NCDATA, ABUND2, NN2, NN1, NNN14
      REAL*8 RRT, NMG25, NSI30, NFE60, RPP, EQ, ZD, CSB
      REAL*8 NN16, CDUM2, RGMG, SCRN, NN4, NRATES, NN19, NN
      REAL*8 CSC, W2, NFE56, RAN, WB, RRT2, CXD, N4
      REAL*8 RCCG, R3A, WR, CMEVMU, NZZ, RR, EXHE, ZA
      REAL*8 W3, NNA23, N24, NP31, RPN, RPC, NN15, NN17
      REAL*8 NRATE, CPL, EX, GE, RCCA, CPI, TF, RAC
      REAL*8 RGNE, RDFE59, RATES, RDN, AUXIN, NNA22, NRT, FCCG
      REAL*8 CLN2, RBP, RATE, NN3, WA, DEXP, TU, NI
      REAL*8 NS34
      INTEGER INT, JW, IML, IN, JCSX, IMO, ICN, IOP
      INTEGER IDIFF, ISGTH, IT, LOG, INUC, MIN, LE, IBC
      INTEGER MAX, J, MOD, ION, I, ICL, LT
